    ...
    <form class="" method="POST" action="">
        ...
        <div class="row">
            <div class="col-4">
                ...
                <input type="text" class="form-control" name="documentoUsuarios" id="documentoUsuarios" value="<?php echo (isset($_POST['submit'])) ?$_POST['documentoUsuarios'] : @$_GET['documento'] ?>" maxlength="15" minlength="5">
            ...
            <div class="col-4">
                ...
                <input type="text" id="datepicker" class="form-control" name="fechaNacimientoUsuarios" maxlength="20" value="<?php echo (isset($_POST['submit'])) ? $_POST['fechaNacimientoUsuarios'] : '' ?>" autocomplete="off">
            </div>
            <div class="col-4">
                <label for="emailUsuarios" class="form-label">Correo Electrónico *<i class="bi bi-asterisk"></i></label>
                <input type="text" class="form-control" name="emailUsuarios" maxlength="80" value="<?php echo (isset($_POST['submit'])) ? $_POST['emailUsuarios'] : "@gmail.com" ?>">
            </div>
        </div>
        <div class="row">
            <div class="col-3">
                <label for="nombre1Usuarios" class="form-label">Primer Nombre *</label>
                <input type="text" class="form-control" name="nombre1Usuarios" maxlength="20" id="nombre1Usuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['nombre1Usuarios'] : '' ?>">
            </div>
            <div class="col-3">
                <label for="nombre2Usuarios" class="form-label">Segundo Nombre</label>
                <input type="text" class="form-control" name="nombre2Usuarios" maxlength="20" id="nombre2Usuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['nombre2Usuarios'] : '' ?>">
            </div>
            <div class="col-3">
                <label for="apellido1Usuarios" class="form-label">Primer Apellido *<i class="bi bi-asterisk"></i></label>
                <input type="text" class="form-control" name="apellido1Usuarios" maxlength="20" id="apellido1Usuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['apellido1Usuarios'] : '' ?>">
            </div>
            <div class="col-3">
                <label for="apellido2Usuarios" class="form-label">Segundo Apellido<i class="bi bi-asterisk"></i></label>
                <input type="text" class="form-control" name="apellido2Usuarios" maxlength="20" id="apellido2Usuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['apellido2Usuarios'] : '' ?>">
            </div>
        </div>
        <div class="row">
            <div class="col">
                <label for="fijoUsuarios" class="form-label">Telefóno Fijo</label>
                <input type="text" class="form-control" name="fijoUsuarios" maxlength="10" id="fijoUsuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['fijoUsuarios'] : '' ?>">
            </div>
            <div class="col">
                <label for="celular1Usuarios" class="form-label">Celular 1 *</label>
                <input type="text" class="form-control" name="celular1Usuarios" maxlength="10" id="celular1Usuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['celular1Usuarios'] : '' ?>">
            </div>
            <div class="col">
                <label for="celular2Usuarios" class="form-label">Celular 2</label>
                <input type="text" class="form-control" name="celular2Usuarios" maxlength="10" id="celular2Usuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['celular2Usuarios'] : '' ?>">
            </div>
        </div>
        <div class="row">
            <div class="col">
                <label for="direccionUsuarios" class="form-label">Dirección</label>
                <input type="text" class="form-control" name="direccionUsuarios" id="direccionUsuarios" value="<?php echo (isset($_POST['submit'])) ? $_POST['direccionUsuarios'] : '' ?>">
            </div>
        </div>
        <div class="row">
            <?php
            ...
            <div class="col-6">
                ...
                <?php else : ?>
                    <label class="form-label" for="nitEmpresas">Empresa *</label>
                    <?php cargarSelect($conexion,  "SELECT nitEmpresas, nombreEmpresas FROM empresas WHERE nitEmpresas = '$_SESSION[nitEmpresas]' ORDER BY nombreEmpresas", "nitEmpresas", "class='form-control' id='nitEmpresas' readonly", $_SESSION['nitEmpresas']) ?>
                <?php endif; ?>
            </div>
        </div>
        <div class="row">
