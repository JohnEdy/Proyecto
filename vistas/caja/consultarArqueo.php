...
$campos = array('fechaRegistro' => 'Fecha Ingreso', 'documentoUsuarios' => 'Documento Cajero', 'idArqueos' => 'Arqueo Id');
//Arcchivo en el que estamos trabajando
$index = 'consultarArqueo';
...
<script>
    ...
    function datosArqueos() {
        $.ajax({
            type: "POST",
            url: "../../ajax/datosBuscarArqueos.php",
            dataType: "json",
