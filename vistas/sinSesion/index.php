      ...
      <div class="signin-signup">
        ...
        <form action="#" class="sign-in-form" action="" method="POST">
          ...
          <div class="input-field">
            ...
            <input type="text" class="input100" name="nombreUsuarios" id="" maxlength="14" placeholder="Documento" autocomplete="off">
          </div>

          <div class="input-field">
            <i class="fas fa-lock"></i>
            <input type="password" class="input100" name="passUsuarios" id="" placeholder="Contraseña" autocomplete="off">
          </div>

          <div style="align-items: center;" class="container-login100-form-btn">
            <input type="submit" name="submitLogin" value="Iniciar Sesión" id="btnSubmit" onclick="spinner();" class="btn btn-primary">
            <div class="spinner-border text-primary submitLogin" style="display: none" role="status" id="spinner">
              <span class="visually-hidden">Loading...</span>
            </div>
          </div>
          <a style="font-size: 9pt; text-decoration:none; color: black;" href="recuperarClave.php">¿Deseas recuperar tu contraseña? <strong>Haz click aquí</strong></a>
    ...
    <div class="panels-container">
      <div class="panel left-panel">
        <div class="">
          ...
          <a class="btn transparent" href="../../index.php">
            Ir Al Sitio Web
          </a>
        </div>
